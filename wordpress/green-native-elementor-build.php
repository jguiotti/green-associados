				...
				'elements' => array(
					array(
						...
						'settings'   => array(
							...
							'menu_typography_font_size' => array( 'unit' => 'px', 'size' => 13, 'sizes' => array() ),
							'menu_typography_font_size_mobile' => array( 'unit' => 'px', 'size' => 11, 'sizes' => array() ),
							'menu_typography_font_weight' => '500',
							'menu_typography_letter_spacing' => array( 'unit' => 'em', 'size' => 0.06, 'sizes' => array() ),
							'color_menu_item' => '#333333',
	...
	'settings'   => array(
		'icon_list' => array(
			array(
				...
				'link'          => array( 'url' => $home_url . '#ia' ),
			),
			array(
				'text'          => 'Governança e RI',
				'selected_icon' => array(
					'value'   => 'fas fa-chevron-right',
					'library' => 'fa-solid',
				),
				'link'          => array( 'url' => $home_url . '#atuacao' ),
			),
		),
		'view'      => 'traditional',
		'icon_color' => '#005646',
...
foreach ( array( 'Política de privacidade' => '#', 'Termos de uso' => '#' ) as $label => $url ) {
	$footer_legal_items[] = array(
		'text'          => $label,
		'selected_icon' => array(
			'value'   => '',
